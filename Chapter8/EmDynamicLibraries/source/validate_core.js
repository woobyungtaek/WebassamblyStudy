...
if (!Object.getOwnPropertyDescriptor(Module, "dlSetError")) Module["dlSetError"] = function() { abort("'dlSetError' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)") };

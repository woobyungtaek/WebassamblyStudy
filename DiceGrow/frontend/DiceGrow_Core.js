...
var wasmBinaryFile;
  wasmBinaryFile = 'DiceGrow_Core.wasm';
...
var ASM_CONSTS = {
  ...
  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 5247024);
...
/** @type {function(...*):?} */
var _Get_Player_HP = Module["_Get_Player_HP"] = function() {
  return (_Get_Player_HP = Module["_Get_Player_HP"] = Module["asm"]["Get_Player_HP"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_MaxHP = Module["_Get_Player_MaxHP"] = function() {
  return (_Get_Player_MaxHP = Module["_Get_Player_MaxHP"] = Module["asm"]["Get_Player_MaxHP"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_Level = Module["_Get_Player_Level"] = function() {
  return (_Get_Player_Level = Module["_Get_Player_Level"] = Module["asm"]["Get_Player_Level"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_Exp = Module["_Get_Player_Exp"] = function() {
  return (_Get_Player_Exp = Module["_Get_Player_Exp"] = Module["asm"]["Get_Player_Exp"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_MaxExp = Module["_Get_Player_MaxExp"] = function() {
  return (_Get_Player_MaxExp = Module["_Get_Player_MaxExp"] = Module["asm"]["Get_Player_MaxExp"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_LevelPoint = Module["_Get_Player_LevelPoint"] = function() {
  return (_Get_Player_LevelPoint = Module["_Get_Player_LevelPoint"] = Module["asm"]["Get_Player_LevelPoint"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_Dice = Module["_Get_Player_Dice"] = function() {
  return (_Get_Player_Dice = Module["_Get_Player_Dice"] = Module["asm"]["Get_Player_Dice"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Player_DicePoint = Module["_Get_Player_DicePoint"] = function() {
  return (_Get_Player_DicePoint = Module["_Get_Player_DicePoint"] = Module["asm"]["Get_Player_DicePoint"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _IncreaseMaxHP = Module["_IncreaseMaxHP"] = function() {
  return (_IncreaseMaxHP = Module["_IncreaseMaxHP"] = Module["asm"]["IncreaseMaxHP"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _IncreaseDiceValue = Module["_IncreaseDiceValue"] = function() {
  return (_IncreaseDiceValue = Module["_IncreaseDiceValue"] = Module["asm"]["IncreaseDiceValue"]).apply(null, arguments);
};
...
/** @type {function(...*):?} */
var _Get_Dec_Point_Player = Module["_Get_Dec_Point_Player"] = function() {
  return (_Get_Dec_Point_Player = Module["_Get_Dec_Point_Player"] = Module["asm"]["Get_Dec_Point_Player"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Attack_Point_Player = Module["_Get_Attack_Point_Player"] = function() {
  return (_Get_Attack_Point_Player = Module["_Get_Attack_Point_Player"] = Module["asm"]["Get_Attack_Point_Player"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Dec_Point_Enemy = Module["_Get_Dec_Point_Enemy"] = function() {
  return (_Get_Dec_Point_Enemy = Module["_Get_Dec_Point_Enemy"] = Module["asm"]["Get_Dec_Point_Enemy"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Attack_Point_Enemy = Module["_Get_Attack_Point_Enemy"] = function() {
  return (_Get_Attack_Point_Enemy = Module["_Get_Attack_Point_Enemy"] = Module["asm"]["Get_Attack_Point_Enemy"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Final_Attack_Player = Module["_Get_Final_Attack_Player"] = function() {
  return (_Get_Final_Attack_Player = Module["_Get_Final_Attack_Player"] = Module["asm"]["Get_Final_Attack_Player"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Final_Attack_Enemy = Module["_Get_Final_Attack_Enemy"] = function() {
  return (_Get_Final_Attack_Enemy = Module["_Get_Final_Attack_Enemy"] = Module["asm"]["Get_Final_Attack_Enemy"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _Get_Turn_Result = Module["_Get_Turn_Result"] = function() {
  return (_Get_Turn_Result = Module["_Get_Turn_Result"] = Module["asm"]["Get_Turn_Result"]).apply(null, arguments);
};
...
var _finalAttackArr_player = Module['_finalAttackArr_player'] = 3568;
var _finalAttackArr_enemy = Module['_finalAttackArr_enemy'] = 3584;
var _turnResultArr = Module['_turnResultArr'] = 3600;
var ___THREW__ = Module['___THREW__'] = 4128;
var ___threwValue = Module['___threwValue'] = 4132;
var ___cxa_new_handler = Module['___cxa_new_handler'] = 3624;
